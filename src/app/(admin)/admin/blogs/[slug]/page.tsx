...
import { useAdminBlogBySlug } from "@/hooks/react-query/admin/blogs/use-query";
...
export default function Page() {
  ...
  const { data: post, isLoading: isLoadingPost } = useAdminBlogBySlug({
    slug: params.slug,
  });
